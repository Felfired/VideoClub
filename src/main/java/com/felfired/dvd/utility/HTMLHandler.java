...
public class HTMLHandler
{
	...
	public static String createHtmlDVDUser(DVD dvd)
	{
		...
		answer += "<head>\n";
		answer += "<title>" + (dvd != null ? dvd.getTitle() : "DVD Not Found") + "</title>\n";
		answer += "</head>\n";
	...
	public static String createHtmlCatalogueUser(List<DVD> dvdList)
	{
		String answer = "<html>\n";
	...
	public static String createHtmlCatalogueAuth(List<DVD> dvdList)
	{
		String answer = "<html>\n";
